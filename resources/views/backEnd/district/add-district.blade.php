...
@section('mainContent')
    ...
    <div class="bo-container">
        <div class="profile-init-div">
            <h1 class="profile-heading">Add New District</h1>
        </div>
        <div class="user-profile-details" style="margin-top: 1rem">
            <form action="{{URL::to('/admin/add-district-save')}}" method="post">
                @csrf
                ...
                <div id="container">
                    ...
                    <span class="input">
                        <input type="text" class="input__field " id="name" value=""  name="name" placeholder="Enter District Name" />
