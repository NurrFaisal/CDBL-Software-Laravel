...
@section('title')Create New IPO @endsection
@section('mainContent')

    <div class="bo-container">
        <div class="profile-init-div">
            <h1 class="profile-heading">Create IPO</h1>
        ...
        <form action="{{URL::to('/admin/new-ipo-save')}}" method="post" >
            @csrf
            <div id="container">
                <span class="input">
                    <input type="text" class="input__field" id="company_name" name="company_name" placeholder="Company Name"/>
                ...
                <span class="input">
                    <input type="text" class="input__field" id="ipo_name" name="ipo_name" placeholder="IPO Name"/>
                ...
                <span class="input">
                    <input type="text" class="input__field" id="lot_size" name="lot_size" placeholder="Lot Size"/>
                ...
                <span class="input">
                    <input type="text" class="input__field" id="price" name="price" placeholder="Price"/>
                ...
                <span class="input">
                    <input class="input__field datepicker" id="start_date" name="start_date" placeholder="Start Date"/>
                ...
                <span class="input">
                    <input class="input__field datepicker" id="end_date" name="end_date" placeholder="End Date"/>
                ...
                <span class="input">
                    <input type="text" class="input__field" id="mr_no" name="mr_no" placeholder="MR No"/>
                ...
                <span class="input">
                    <input type="text" class="input__field" id="ac_type" name="ac_type" placeholder="Ac Type"/>
                ...
                <span class="input">
                    <input type="text" class="input__field" id="rcv_type" name="rcv_type" placeholder="RCV Type"/>
