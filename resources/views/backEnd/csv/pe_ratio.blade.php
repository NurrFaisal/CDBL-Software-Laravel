...
@section('mainContent')
    ...
    <div class="bo-container">
        <div class="profile-init-div">
            <h1 class="profile-heading">PE Ratio Import</h1>
        </div>
        <div class="user-profile-details" style="margin-top: 1rem; padding: 5rem 0rem">
            ...
            @endif
            <form action="{{URL::to('/admin/pe-ratio-save')}}" method="post" enctype="multipart/form-data" onsubmit="return Validate(this)">
                @csrf
