...
@section('title') PE Ratio Import@endsection
@section('mainContent')
    ...
    <div class="bo-container">
        <div class="profile-init-div">
            <h1 class="profile-heading">Accrued Charge</h1>
        </div>
        <div class="user-profile-details" style="margin-top: 1rem; padding: 5rem 0rem">
            ...
            @endif
            <form action="{{URL::to('/admin/accrued-charge')}}" method="post" enctype="multipart/form-data" onsubmit="return Validate(this)">
                @csrf
                <label for="et_pb_contact_brand_file_request_0" class="et_pb_contact_form_label">Enter</label>
                <input type="file" id="et_pb_contact_brand_file_request_0" name="name" class="file-upload" required  accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" >
