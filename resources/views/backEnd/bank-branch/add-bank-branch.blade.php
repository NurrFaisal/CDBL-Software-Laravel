...
@section('mainContent')
    ...
    <div class="bo-container">
        ...
        <div class="user-profile-details" style="margin-top: 1rem">
            <form action="{{URL::to('/admin/add-bank-branch-save')}}" method="post">
                @csrf
                ...
                <div id="container">
                    ...
                    <span class="input">
                        <input type="text" class="input__field " id="name" value=""  name="name" placeholder="Enter Bank Branch Name" />
                    ...
                    <span class="input">
                        <input type="text" class="input__field " id="bank_routing" value=""  name="bank_routing" placeholder="Enter Bank Branch Name" />
