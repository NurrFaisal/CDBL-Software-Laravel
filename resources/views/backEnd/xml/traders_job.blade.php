...
@section('title') Traders Job Import@endsection
@section('mainContent')
    ...
    <div class="bo-container">
        <div class="profile-init-div">
            <h1 class="profile-heading">Traders Job Import</h1>
        </div>
        <div class="user-profile-details" style="margin-top: 1rem; padding: 5rem 0rem">
            ...
            @endif
            <form action="{{URL::to('/admin/traders-job-import')}}" method="post" enctype="multipart/form-data" onsubmit="return Validate(this)">
                @csrf
