...
@section('title') BO Change Request List @endsection
@section('mainContent')
    ...
    <div class="bo-container">
        <h1 class="profile-heading">BO Change Request List</h1>
        ...
        <div class="user-profile-details">
            <table class="table">
                ...
                @foreach($request_bo_accounts as $request_bo_account)
                    <tr>
                        <td>{{$i++}}</td>
                        <td>{{$request_bo_account->bo_id}}</td>
                        ...
                        <td>{{$request_bo_account->occupation}}</td>
                        <td>{{$request_bo_account->fathers_name}}</td>
                        <td>{{$request_bo_account->mothers_name}}</td>
                        <td>{{$request_bo_account->contact_address}}</td>
                        <td>{{$request_bo_account->gender}}</td>
...
{{--                            <a href="{{URL::to('/admin/bo-details/view/'.$request_bo_account->id)}}"><i class="fa fa-eye action-icon"></i></a>--}}
                            <a href="{{URL::to('/admin/bo-change-request-edit/'.$request_bo_account->id)}}"><i class="fa fa-edit action-icon"></i></a>
{{--                            <a href="{{URL::to('/admin/bo-details/delete/'.$request_bo_account->id)}}"><i class="fa fa-trash action-icon"></i></a>--}}
