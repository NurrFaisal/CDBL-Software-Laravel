...
class CreateChangeRequestsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('change_requests', function (Blueprint $table) {
            ...
            $table->integer('n1g_city')->nullable();
            $table->string('n1g_division')->nullable();
            $table->string('n1g_country')->nullable();
            $table->string('n1g_mobile')->nullable();
            $table->string('n1g_tel')->nullable();
            $table->string('n1g_fax')->nullable();
            $table->string('n1g_email')->nullable();
